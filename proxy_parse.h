...
int ParsedRequest_parse(ParsedRequest *parse, const char *buf,
                        int buflen);
...
/*
   ...
   unparse().
 */
int ParsedRequest_unparse(ParsedRequest *pr, char *buf,
                          size_t buflen);
...
/*
   ...
   unparsed.
 */
int ParsedRequest_unparse_headers(ParsedRequest *pr, char *buf,
                                  size_t buflen);
...
int ParsedHeader_set(ParsedRequest *pr, const char *key,
                     const char *value);
